    ...
    function load() {
        ...
        var libsConfig = {
            ...
            'bootstrap-datetimepicker': [
                libpath + "bootstrap/bootstrap-datetimepicker/bootstrap-datetimepicker.css",
                libpath + "bootstrap/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js",
                // libpath + "bootstrap/bootstrap-datetimepicker/locale/bootstrap-datetimepicker-zh-CN.js"
            ],
            'bootstrap-select': [
            ...
            'cesium-mars': [
                ...
                libpath + "CesiumPlugins/d3/d3.js",
                libpath + "CesiumPlugins/d3/d3-scale.min.js",
                libpath + "CesiumPlugins/d3/d3-delaunay.min.js",
                libpath + "CesiumPlugins/d3/d3-tricontour.min.js",
                libpath + "CesiumPlugins/heatmap/heatmap_modify.js",
                libpath + "CesiumPlugins/heatmap/HeatmapImageryByContour.js",
            ],
            'green-tide-windy': [
                libpath + "green_tide/windy/Windy_green_tide.js",
            ],
            'green-tide-pcolor': [
                libpath + "green_tide/pcolor/pcolor.js",
            ],
            'green-tide-kde': [
                libpath + "green_tide/kde/kde.js",
            ],
            'colorpicker': [
                libpath + "colorpicker/colorpicker.js",
            ]
        };
